...
export default function UserItem({ imageUrl, username, isLive }: Props) {
  ...
  return (
    <Button asChild variant="ghost" className={cn("w-full h-12", collapsed ? "justify-center" : "bg-accent")}>
      <Link href={href}>
